    ...
    <main>
        ...
        <div class="container p-3" style="min-height: 80vh;">
            <div class="row mb-3 mx-3">
                <h3 class="text-center bg-primary text-white p-1 rounded">MY POSTS</h3>
            </div>
            <?php
                ...
                if (empty($liked_posts)) { ?>
                    <div class='row justify-content-center'>
                        <div class="alert alert-info text-primary" role="alert" style="width: 60%;">
                            ...
                            <h6> You haven't created any posts yet.</h6>
                            <hr>
                            <p class="mb-1"> Go to "posts" and click on the "Create a New Post" button. Then add information about your new post and submit.</p>
                        </div>
                    </div>
                    <?php } else {
