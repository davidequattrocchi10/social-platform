<?php
$check_username = strlen($_POST['username']) <= 7;
$check_email = (!str_contains($_POST['email'], '@') || !str_contains($_POST['email'], '.'));
$name = [$_POST['name'], $_POST['lastname'], $_POST['username'], $_POST['email'], $_POST['birthdate'], $_POST['phone']];
var_dump($name);
?>
